...
export default {
  ...
  actions: {
    ...
    [types.GET_NODE_LIST]: ({}, workflow_id) => {
      return workflow.getNodeList(workflow_id)
    },
    [types.GET_WORKFLOW_PREVIEW]: ({}, workflow_id) => {
